import { BriefcaseBusiness, Check, User2, UserPen } from "lucide-react"
    ...
    <Popover>
      ...
      >
        <div className="flex items-center justify-between p-4 text-sm">
          <strong>Farmacia Luanda Sul</strong>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <div className="flex items-start gap-3 p-4 transition-all hover:cursor-pointer hover:rounded-sm hover:bg-neutral-50">
              <UserPen className="h-6 w-6 text-emerald-500" />

              <div className="flex flex-col">
                <strong>Minha conta</strong>
                <span className="text-neutral-700 text-sm">
                  Editar dados da sua farmácia
                </span>
              </div>
            </div>
          </DialogTrigger>
          ...
          <DialogContent>
            <DialogTitle>Actualizar Dados da Farmácia</DialogTitle>
            <DialogDescription>
              Actualize os dados da sua farmácia
            </DialogDescription>
